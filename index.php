...
?>
    ...
    <main class="container head-foot-spacing">
        ...
        <div class="jumbotron">
            <?php
            $date = date("Y-m-d");
            $result = $dbh->query("SELECT name, city, date, notes, genre, country FROM concert, artist WHERE date >= '$date' AND attend = TRUE AND concert.artist = artist.artist_id ORDER BY date LIMIT 1");
